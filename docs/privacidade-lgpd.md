...
Enel RJ: Lista de Instalações segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [contas_enel_rj_instalacoes@mcp.ai](mailto:contas_enel_rj_instalacoes@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
